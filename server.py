...
def getTracks():
    ...
    # song_name, song_duration, song_popularity, release_date, artist_name = get_top_songs_over_release_date_vs_popularity(sp)
    # bar = plot_top_songs_over_release_date_vs_popularity(song_name, song_duration, song_popularity, release_date, artist_name)
    top_tracks_df = get_top_tracks_data(sp)
    # top_artists_df = get_top_artists_data(sp)
    return render_template('base.html',
                           tables=[
                               #    top_artists_df.to_html(classes='data'),
                               top_tracks_df.to_html(classes='data')],
                           titles=[
                               #    top_artists_df.columns.values,
                               top_tracks_df.columns.values]
                           #    , plot=bar
                           )
